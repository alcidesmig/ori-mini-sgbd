main: main.c menu.c commands.c tools.c utils.c parser.c defines.c commandsTools.c commandsDefines.c searchStructs.c linenoise/*.cpp
	g++ -std=c++11 -o main btree/*.cpp hash/*.c main.c menu.c commands.cpp tools.c utils.c parser.c defines.c commandsTools.cpp commandsDefines.c searchStructs.c linenoise/*.cpp -I -O3 -fstrength-reduce -fthread-jumps -frerun-loop-opt
clean:
